...
public class FastClearLootDrooper : MonoBehaviour
{
    ...
    public void SpawnItems()
    {
        ...
        for(int i = 1; i < spawningPoint.transform.childCount; i++)
        {
            Destroy(spawningPoint.transform.GetChild(i).gameObject);
        }
